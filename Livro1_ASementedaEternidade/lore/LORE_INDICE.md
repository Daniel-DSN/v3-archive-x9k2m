# ÍNDICE DA LORE — Alyndra: A Semente da Eternidade

> **Versão:** 1.0 | **Criado em:** Valen 6, Nyra de Audin (jun 2026)
> **Status:** Sessão de definição de lore com o autor
...
| Arquivo | Conteúdo |
|---------|----------|
| [VOZ_PERSONAGENS.md](VOZ_PERSONAGENS.md) | Perfis de voz v2.1. Alyndra, Lyris, Velatrix. Jargões chiclete. |

## Arquivos do Projeto

| Arquivo | Conteúdo |
|---------|----------|
| [../final/ENREDO_LIVRO1_MASTER.md](../final/ENREDO_LIVRO1_MASTER.md) | Enredo completo do Livro I. Arcos, capítulos, personagens. |
| [../MASTER_TIMELINE.md](../MASTER_TIMELINE.md) | Timeline cronológica dos eventos. |
...
### Seraphyens
- 10 seres (5 luz + 5 sombra, 5 elementos)
- **Myrrhiel ♂**: água-sombra, braço direito e escudo de Ilyos, amor mútuo, morto em combate
- **Elarys ♀**: fogo-sombra, amava Nyxalor (ele a traiu), selou-se no corpo dele
...
### Descendência
- Ilyos + Myrrhiel → filhos orgânicos: **Mareth** ♂ e **Nymyra** ♀
- Mareth → Casa Marethyus (ramo principal)
- 5 famílias sobreviventes: Marethyus, Nymyrias, Vorrath, Aelythar, Theryllis
- Vários ramos extintos por guerras
...
| # | Ponto | Status |
|---|-------|--------|
| 1 | Confirmar elemento de Myrrhiel como "água-sombra" | Pendente confirmação do autor |
| 2 | Nome do segundo líder Nihilary (lutou contra Alyndra Primordial) — Vha-Korath assumiu esse papel? | Confirmado: Vha-Korath |
| 3 | Detalhar os 7 Seraphyens restantes (nomes, elementos, destinos) | Pendente |
| 4 | Reescrever o Prólogo com base na nova lore | Pendente |
| 5 | Atualizar ENREDO_LIVRO1_MASTER.md com a nova lore | Pendente |
| 6 | Atualizar Cap 5 (poema de Veridion, "dez" → não precisa mudar pois poemas usam "dez") | Verificar |
| 7 | Integrar lore nova com arquivos que o Gemini está criando | Pendente |

---

*Fim do índice v1.0 — atualizar conforme novos documentos de lore sejam criados.*
