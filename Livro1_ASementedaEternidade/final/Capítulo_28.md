...
A ordem partiu pelo cristal como um raio que se ramifica: em *Sanctrum*⁷, os operativos de inteligência³ receberam a transmissão e pararam o que estavam fazendo — relatórios, vigilância, contra-inteligência — e se prepararam para a única missão que importava. Em *Zephyra*⁹, o sinal alcançou os canais secundários e foi retransmitido para as células operacionais no interior de *Sylvaris*¹⁰. Em *Fulmora*¹¹, os contatos comerciais que a rede mantinha sob fachadas de importação e exportação receberam o alerta codificado e começaram a rastrear rotas de *cargas fantasmas*¹².
...
Na *Torre de Aurion*², o gabinete de Selynis se tornou o que ela sempre soube que poderia se tornar: o centro de coordenação de uma operação continental. Mesas de cristal ativadas, projetando mapas tridimensionais de cada reino, com pontos luminosos marcando as posições conhecidas das equipes de busca e as rotas suspeitas de *cargas fantasmas*¹². Operativos entravam e saíam sem que se falassem — a comunicação no gabinete não era verbal; era gestual, um sistema de sinais que os serviços de inteligência³ haviam padronizado sob supervisão de Selynis e que permitia que vinte pessoas trabalhassem na mesma sala sem trocar uma única palavra audível.
...
E a quinta equipe — a equipe de cobertura aérea — partiu em *Koramis*³¹, três aves de cristal treinadas para transporte rápido de um único passageiro cada, seguindo rotas que nenhum *velrok*²⁹ podia percorrer. O *aetherite*²⁶ que as montarias carregavam nos arreios permitia que os passageiros se comunicassem com o gabinete mesmo em voo — uma tecnologia que os engenheiros do Conselho haviam desenvolvido para operações de resgate, e que nunca tinha sido usada em escala continental.
...
— Estou enviando uma solicitação para o gabinete de coordenação — o capitão disse.
...
O capitão enviou. A resposta veio em menos de um segundo — o nome *Kalúdris*³³ havia acionado um protocolo automático de aprovação que Selynis havia estabelecido para casos de emergência. Se um homem da *Kalúdris*³³ estava pedindo uma equipe de resgate, o pedido não era impulso — era cálculo.

Aldric³² recebeu seis operativos, *velroks*²⁹ de marcha, suprimentos para dez dias, e autorização para operar em território de *Sylvaris*¹⁰ e *Fulmora*¹¹ sob protocolo de emergência.
...
— Eu sabia que iam atacar *alguém* — Aldric³² corrigiu. — Não sabia que seria o orfanato. Não sabia que seria *ela*. — Uma pausa. — Mas sabia que o padrão das rotas apontava para uma operação grande. E comuniquei isso ao canal de inteligência há quatro meses.
...
— O *Ponto Ômega*²⁸. Eu rastreei as convergências de rota até lá. Todas as linhas se cruzam no mesmo lugar — um templo abandonado nas planícies de cinza. Não há nome nos registros oficiais. Nos registros de inteligência, é designado como *Ponto Ômega*²⁸.

— Como você tem acesso aos registros de inteligência?

Aldric³² não respondeu diretamente. Em vez disso, tirou do bolso interno da túnica um cristal opaco — não azul-esverdeado como os cristais padrão de campo, mas cinza, com veios de luz que pulsavam em um padrão que Lyris²⁴ reconheceu como o protocolo antigo de inteligência, um padrão que existia antes da padronização atual.
...
² **Torre de Aurion** — Ponto mais alto de *Sanctrum*; abriga o *Solar Privado do En Me* e os gabinetes do Conselho dos 12.

³ **serviços de inteligência** — Redes de informação e contra-informação do Conselho dos 12, responsáveis por segurança continental.
...
²² **gabinete de coordenação** — Centro de operações na *Torre de Aurion* usado durante emergências continentais.
...
²⁵ **Daress** — Operativo de inteligência infiltrado na fronteira *Fulmora*-*Umbra*.
...
²⁸ **Ponto Ômega** — Designação nos registros de inteligência para o templo abandonado na fronteira *Fulmora*-*Umbra*.
