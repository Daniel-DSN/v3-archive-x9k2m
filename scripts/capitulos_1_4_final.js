  ...
  sections: [
    // CAPA
    {
      ...
      children: [
        ...
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { before: 1500 },
          children: [new TextRun({ text: "Versão Final Revisada", size: 22, color: colors.secondary, font: "Times New Roman", italics: true })]
        }),
        new Paragraph({
          alignment: AlignmentType.CENTER,
          spacing: { before: 100 },
    ...
    // CONTEÚDO PRINCIPAL
    {
      ...
      children: [
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "— Grazielly? — a voz de Tomás interrompeu suas observações. O menino de seis anos, que a seguia como um patinho desde que conseguia andar, aproximou-se correndo, sua perna esquerda mancando levemente como sempre fazia quando estava cansado.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "Dialog",
          children: [new TextRun({ text: "— A Mestra Liora está chamando — ele disse, ofegante. — Tem visitantes. Visitas importantes, ela disse.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "Grazielly levantou-se, sacudindo as folhas secas de seu vestido simples. Seu coração acelerou por um instante, mas seu rosto permaneceu sereno.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "Dialog",
          children: [new TextRun({ text: "— Obrigada, Tomás.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "Ela não perguntou quem — seus olhos já haviam avistado o grupo que se aproximava do portão principal. Três figuras: duas em túnicas formais da Academia Elemental, e uma terceira, mais velha, com vestes que indicavam autoridade.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "Thought",
          children: [new TextRun({ text: "Academia Elemental. Estão recrutando. Mas não vêm apenas para isso — a mulher no centro carrega documentos selados. Procuram alguém específico. Alguém já foi escolhido antes de chegarem.", color: colors.secondary })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "O Pyrallis pressentiu sua tristeza e encostou a cabeça em sua mão, emitindo um som suave que parecia um ronronar misturado com um canto. Suas orelhas grandes giraram em direção a ela, captando cada nuances de sua respiração, de seu batimento cardíaco.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "Grazielly estudou a estátua com novos olhos. Ventus. O Seraphyen que ajudou a criar o selo. O Seraphyen que ficou ao lado de Ilyos quando todo o universo estava em jogo. Havia algo naquela história que ressoava dentro dela, como uma corda que vibrava em uma frequência que ela não sabia que existia.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "Dialog",
          children: [new TextRun({ text: "— Pode voltar ao seu lugar — o mestre disse, mais seus olhos permaneceram fixos nela por um momento a mais do que o necessário. — Vamos... investigar isso mais tarde. Com métodos alternativos.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "Dialog",
          children: [new TextRun({ text: "— É como a Academia avalia o progresso dos alunos na prática — Helena explicou, finalmente recuperando o fôlego. — Acontecem todo mês. Os melhores são selecionados para competições maiores, como os Desafios dos Sete Ventos, que são regionais. E depois... depois existe O Conclave dos Prodigium, que reúne os melhores de todos os Sete Reinos.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "✅ Ayla: Mãe de Grazielly, morreu no parto. Distinção clara de Elainy.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "✅ Elainy: Futura rival de Grazielly, aparece apenas em O Conclave dos Prodigium.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "✅ Ventus: Seraphyen de Vento Luz que ficou ao lado de Ilyos. Estátua na entrada da Academia, mencionada por Mira.", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "✅ Noah: Afinidade com INTELIGÊNCIA estabelecida claramente. Não é luta, é percepção de padrões e estratégia.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "1. Certames de Aethra: Torneios locais mensais. Onde Grazielly começará a se destacar gradualmente.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "3. O Conclave dos Prodigium: Torneio principal a cada 5 anos, TODOS os reinos. Onde Elainy aparece. Onde Noah descobre sua afinidade com inteligência.", color: colors.body })]
        }),
        ...
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "• Ignis/Ignisara - Fogo Luz | Elarys - Fogo Sombra (linhagem de Grazielly)", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "• Aquarys/Aquaryn - Água Luz | Mareth - Água Sombra", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "• Terrys/Terrador - Terra Luz | Lithos - Terra Sombra", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "• Fulgoris/Fulgur - Relâmpago Luz | Voltaris - Relâmpago Sombra", color: colors.body })]
        }),
        
        new Paragraph({
          style: "BodyText",
          children: [new TextRun({ text: "• Ventus - Vento Luz (lutou ao lado de Ilyos) | Tempest - Vento Sombra", color: colors.body })]
        }),
...
Packer.toBuffer(doc).then(buffer => {
  fs.writeFileSync("/home/z/my-project/download/Alyndra_Capitulos_1_4_Final.docx", buffer);
  console.log("Documento criado com sucesso: /home/z/my-project/download/Alyndra_Capitulos_1_4_Final.docx");
});
