...
const doc = new Document({
  styles: {
    ...
    paragraphStyles: [
      { id: "Title", name: "Title", basedOn: "Normal", run: { size: 56, bold: true, color: "000000", font: "Times New Roman" }, paragraph: { spacing: { before: 240, after: 120 }, alignment: AlignmentType.CENTER } },
      { id: "Heading1", name: "Heading 1", basedOn: "Normal", next: "Normal", quickFormat: true, run: { size: 32, bold: true, color: "000000", font: "Times New Roman" }, paragraph: { spacing: { before: 240, after: 240 }, outlineLevel: 0 } }
    ]
  },
  sections: [{
    ...
    children: [
      // CAPÍTULO 2
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 }, children: [new TextRun({ text: "CAPÍTULO II", bold: true, size: 32, smallCaps: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O Orfanato das Asas ficava nas colinas suaves do Reino de Aetherion, onde o céu parecia mais azul e o ar mais leve. Era um lugar de pedra clara e janelas sempre abertas, cercado por campos de Sylvaris — flores pequenas e coloridas que cobriam as colinas como um manto vivo. Quando o vento passava por elas, as Sylvaris emitiam um som suave como sinos distantes, uma melodia que os moradores locais chamavam de 'canção da brisa'.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O nome do orfanato vinha da tradição local — dizia-se que as almas das crianças perdidas encontravam ali asas para voar novamente. Era uma crença antiga, do tempo em que os Aeros ainda voavam livremente pelos céus de Aetherion, antes das guerras que mudaram tudo.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O Reino de Aetherion era conhecido por ser o mais tranquilo dos sete reinos. Enquanto Pyronar fervilhava com paixão e disputas, enquanto Hydoria navegava por políticas complexas, Aetherion simplesmente... existia. Seu povo valorizava a liberdade acima de tudo, a alegria simples da vida cotidiana, a paz que vem de não querer mais do que se tem.", size: 24 })] }),
      ...
      // A OBSERVADORA
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Enquanto outras crianças corriam atrás de Aetheris — insetos alados de asas iridescentes que deixavam rastros brilhantes no ar — ou choravam por pais que nunca conheceriam, Grazielly sentava sob a Aetheris Arbor mais alta do jardim e observava. Observava tudo, com uma intensidade que às vezes incomodava os adultos.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Ela observava a forma como as nuvens se moviam antes de uma tempestade. Observava como os Zephyr — aves de asas longas que pareciam feitas de brisa sólida — sabiam exatamente quando se abrigar. Observava o jeito que a Mestra Liora sorria quando pensava que ninguém estava olhando — um sorriso triste, de alguém que carregava memórias que preferia esquecer. Observava como Tyrell, o menino de seis anos que a seguia como um filhote de Lupis, mancava levemente da perna esquerda quando estava cansado.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Você é estranha —", size: 24 }), new TextRun({ text: " Tyrell disse certa vez, sentando-se ao lado dela sob a áetheris arbor. Não era uma acusação — era uma observação curiosa, a forma como uma criança fala quando descobre algo novo.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Eu sei —", size: 24, italics: true }), new TextRun({ text: " ela respondeu. ", size: 24 }), new TextRun({ text: "Mas você gosta de mim assim.", size: 24, italics: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Tyrell riu, porque era verdade. Grazielly era estranha, sim. Mas era a estranha que contava as melhores histórias, que sabia quando alguém estava triste antes mesmo de chorar, que nunca julgava ninguém por ser diferente.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O céu de Alyndra era diferente de qualquer outro — não que Grazielly soubesse disso. Aurion, o sol dourado-alaranjado, já se punha no oeste, deixando o céu tingido de tons de laranja e rosa. E acima, emergindo lentamente no crepúsculo, as maravilhas do universo se revelavam.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O Orfanato das Asas ficava próximo a uma estrada comercial, e viajantes de todos os reinos passavam por ali buscando água e descanso. Grazielly sempre se oferecia para ajudar — trazendo água, servindo pão, escovando Koras, os animais de montaria de pernas longas e crina que fluía mesmo sem vento. Em troca, ela pedia apenas uma coisa: histórias.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Ela ouvia tudo. Notícias de Pyronar, onde um novo torneio fora anunciado. Rumores de Umbralis, onde as sombras pareciam mais densas nos últimos tempos. Histórias de batalhas antigas, de heróis lendários, de criaturas que habitavam as fronteiras do mundo conhecido.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Os Vanguardas são heróis mascarados —", size: 24 }), new TextRun({ text: " um mercador lhe contou certa vez, seus olhos brilhando com a empolgação de alguém que adora uma boa história. ", size: 24 }), new TextRun({ text: "Eles operam fora da lei, protegendo os fracos quando a justiça oficial falha. Ninguém sabe quem são debaixo das máscaras. Usam codinomes de animais — Lobo, Coruja, Falcão.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Eles são... criminosos? —", size: 24, italics: true }), new TextRun({ text: " Grazielly perguntou, intrigada.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O mercador riu.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— O Grande Mestre diz que sim. Condena-os publicamente. Mas...", size: 24, italics: true }), new TextRun({ text: " ele baixou a voz, como se compartilhasse um segredo. ", size: 24 }), new TextRun({ text: "Quando os Vanguardas salvaram minha vila de bandidos, nenhum soldado apareceu por semanas. As pessoas sabem a verdade. Os Vanguardas são heróis. Heróis que o mundo precisa, mesmo que não admita.", size: 24, italics: true })] }),
      ...
      new Paragraph({ alignment: AlignmentType.CENTER, spacing: { before: 200, after: 200 }, children: [new TextRun({ text: "Eu vou ser como eles um dia.", size: 24, bold: true, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Grazielly estava no jardim, observando um Kryll carregar uma folha três vezes maior que ele. O pequeno artrópode de exoesqueleto translúcido brilhava levemente no sol, suas patas deixando rastros de Aethra residual enquanto trabalhava. Era fascinante — a determinação da criatura, a forma como contornava obstáculos, a persistência mesmo quando a folha parecia pesada demais.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Ela estava tão concentrada que quase não ouviu a Mestra Liora chamá-la.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Grazielly! —", size: 24, bold: true }), new TextRun({ text: " a voz da mestra tinha um tom estranho. ", size: 24 }), new TextRun({ text: "Pode vir até a cozinha? Há... alguém que quer falar com você.", size: 24, bold: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Na cozinha, havia um homem esperando. Alto, vestido com o uniforme azul-prateado da Academia Elemental de Aetherion, um cristal pendurado ao pescoço que brilhava suavemente. Seus olhos examinaram Grazielly da cabeça aos pés — não com julgamento, mas com curiosidade científica.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Então esta é a criança —", size: 24, italics: true }), new TextRun({ text: " ele murmurou, mais para si mesmo do que para os outros. Se ajoelhou para ficar na altura de Grazielly. ", size: 24 }), new TextRun({ text: "Olá, pequena. Eu sou o Mestre Corin, da Academia Elemental. Você sabe o que é uma Academia Elemental?", size: 24, italics: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Grazielly assentiu.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— É onde as crianças aprendem a usar seus elementos —", size: 24, italics: true }), new TextRun({ text: " ela disse. ", size: 24 }), new TextRun({ text: "Pyron, Hydros, Terrax, Aeros, Fulgor, Lumin e Umbra.", size: 24, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Muito bom. E você sabe qual é o seu elemento?", size: 24, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Não —", size: 24, italics: true }), new TextRun({ text: " ela disse simplesmente. ", size: 24 }), new TextRun({ text: "Não tenho elemento.", size: 24, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Isso é o que os cristais dizem —", size: 24, italics: true }), new TextRun({ text: " ele disse. ", size: 24 }), new TextRun({ text: "Mas cristais podem ser enganados. Ou... podem não saber ler o que veem. —", size: 24, italics: true }), new TextRun({ text: " Ele tirou do bolso um pergaminho com um selo prateado. ", size: 24 }), new TextRun({ text: "Grazielly, você é a criança que faz perguntas difíceis, não é? A que perguntou ao mercador por que os preços variam conforme as fases de Lyria.", size: 24, bold: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Grazielly assentiu novamente, sem sorrir.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— A maré afeta o transporte —", size: 24, italics: true }), new TextRun({ text: " ela explicou. ", size: 24 }), new TextRun({ text: "E Lyria afeta a maré. Quando Lyria está cheia, a maré sobe mais. Os barcos podem carregar mais carga, mas também enfrentam correntzas mais fortes. Isso afeta os preços.", size: 24, italics: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Houve um silêncio. A Mestra Liora parecia tão impressionada quanto o Mestre Corin. Tyrell, que observava da porta com outras crianças, arregalava os olhos.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Como você sabe disso? —", size: 24, italics: true }), new TextRun({ text: " o Mestre Corin perguntou, sua voz agora séria.", size: 24 })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Eu observei —", size: 24, italics: true }), new TextRun({ text: " Grazielly disse. ", size: 24 }), new TextRun({ text: "E perguntei. E escutei as respostas.", size: 24, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Grazielly —", size: 24, bold: true }), new TextRun({ text: " ele disse, ", size: 24 }), new TextRun({ text: "a Academia Elemental normalmente aceita crianças a partir dos dez anos. Mas às vezes... às vezes encontramos alguém especial. Alguém que pensa diferente. Alguém que vê o que outros não veem. —", size: 24, bold: true }), new TextRun({ text: " Ele estendeu o pergaminho. ", size: 24 }), new TextRun({ text: "Sua inscrição já foi aprovada. Uma bolsa especial, custeada por... um benfeitor anônimo. Você começa na próxima segunda-feira.", size: 24, italics: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "— Obrigada —", size: 24, italics: true }), new TextRun({ text: " ela disse, com a voz firme e os olhos brilhando. ", size: 24 }), new TextRun({ text: "Não vou desperdiçar essa chance.", size: 24, italics: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "O Mestre Corin assentiu, impressionado. A Mestra Liora tinha lágrimas nos olhos. E Tyrell correu para contar a todos que sua amiga Grazielly ia para a Academia.", size: 24 })] }),
      
      // O BENFEITOR
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Ninguém no orfanato sabia quem era o benfeitor anônimo.", size: 24, italics: true })] }),
      
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Ninguém sabia que, em um palácio distante no Reino de Aetheria, o Décimo Segundo Grande Mestre de Nova Aetherion havia recebido um relatório sobre uma órfã do Reino de Aetherion. Um relatório que mencionava uma criança de sete anos, sem afinidade detectável, mas com uma inteligência incomum.", size: 24 })] }),
      ...
      // ACADEMIA
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "A Academia Elemental de Aetherion erguia-se como um palácio de contos de fadas.", size: 24, bold: true })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "A Mestra Liora não pudera acompanhá-la — o orfanato exigia sua presença. Tyrell queria vir, mas era pequeno demais para entender o que aquele dia significava. Não havia mais ninguém.", size: 24 })] }),
...
Packer.toBuffer(doc).then(buffer => {
  ...
  console.log("Capítulo 2 atualizado!");
});
