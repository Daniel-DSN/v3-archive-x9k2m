...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      // ═══════════════════════════════════════════════════════════════
      // FLASH PRIMORDIAL - EXPANDIDO E EPICO
      // ═══════════════════════════════════════════════════════════════
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " A voz de Nyxalor era muitas vozes, um coro dissonante de Vorynthrix e dos outros Nihilaryth falando através dele. ", size: 24 }),
        new TextRun({ text: "Você ainda acredita que pode me salvar? Que há algo do seu amado irmão restante aqui?", italics: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " Ilyos gritou, sua voz ecoando através das dimensões.", size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        new TextRun({ text: "— Ilyos —", italics: true, size: 24 }),
        new TextRun({ text: " ela disse, sua voz ecoando através do tempo. ", size: 24 }),
        new TextRun({ text: "A luz não pode brilhar sem as sombras que a definem. Eu não estou te deixando. Estarei em cada sombra que sua luz criar. Brilhe por nós duas.", italics: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " Ilyos disse, e havia lágrimas em sua voz — lágrimas de luz pura que caíam como estrelas cadentes através das dimensões. ", size: 24 }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " Nyxalor sussurrou, sua voz verdadeira, sem o coro dissonante. ", size: 24 }),
        new TextRun({ text: "Eu não queria... não consigo...", italics: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        new TextRun({ text: "— Descanse, minha irmã —", italics: true, size: 24 }),
        new TextRun({ text: " Ilyos sussurrou. ", size: 24 }),
        new TextRun({ text: "Sua luz vive em mim. Sua sombra vive em cada canto que eu iluminar. Você não está morta — está espalhada pelo universo que você salvou.", italics: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Não era uma tempestade comum. Os curandeiros mais velhos sussurravam que algo no próprio céu estava reagindo — como se o universo testemunhasse um momento que mudaria tudo. Relâmpagos cruzavam os céus tropicais do Reino da Água em padrões que não seguiam nenhuma lei natural, dançando em espirais que pareciam formar símbolos antigos.", size: 24 })] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        new TextRun({ text: "— A mãe está muito fraca! —", bold: true, size: 24 }),
        new TextRun({ text: " alguém gritou. ", size: 24 }),
        new TextRun({ text: "A transfusão de Aethra não está funcionando!", bold: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " a curandeira-chefe sussurrou, lágrimas em seus olhos. Com cuidado, ela colocou a criança nos braços da mãe. ", size: 24 }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " alguém sussurrou, confuso. ", size: 24 }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        ...
        new TextRun({ text: " ela murmurou, usando as últimas forças que lhe restavam. ", size: 24 }),
        new TextRun({ text: "Seu nome é Grazielly. Significa 'graça' na língua antiga. Porque você é minha graça... minha herança... meu amor.", italics: true, size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [
        new TextRun({ text: "— Mestra Ayla! Não! —", bold: true, size: 24 }),
        new TextRun({ text: " A curandeira-chefe correu para ela, tentando canalizar energia, mas era tarde demais.", size: 24 })
      ] }),
      ...
      new Paragraph({ spacing: { after: 200, line: 312 }, children: [new TextRun({ text: "Longe dali, em um palácio flutuante no Reino Central, um homem sentiu algo.", size: 24 })] }),
